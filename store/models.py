...
class Product(models.Model):
    ...
    discription=models.TextField(max_length=255,null=True)
...
class Order(models.Model):
    customer=models.ForeignKey(Purchaser,on_delete=models.SET_NULL,blank=True,null=True)
...
class Feedback(models.Model):
    ...
    def __str__(self):
        return 'Feeback {} by {}'.format(self.Subject, self.FirstName)
